        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto text-center text-lg text-gray-600 leading-relaxed space-y-6">
            ...
            <p>
              ...
              especialistas en el desarrollo de proyectos bajo los subsidios
              DS 49 y DS 27.
            </p>
            ...
            <p>
              ...
              el hogar de una familia y contribuir al desarrollo de una comunidad.
            </p>

            <p>
              En DUVA no solo construimos viviendas o mejoramos entornos urbanos;
              trabajamos para generar espacios que entreguen seguridad, bienestar
              y nuevas oportunidades, transformando positivamente la vida de
              quienes los habitan.
            </p>
